...
export class TypescriptComponent {
    ...
    setBasicType: string;
    setClass: string;
    setDeclarationsMerging: string;
    setDecorator: string;
    setEnum: string;
    setFunction: string;
    setDestructuring: string;
    setObjectInObject: string;
    ...
    setLeftPadEx(): void {
        this.setLeftPad = `
        //any Ver.
        function padLeft_1(value: string, padding: any) {
        ...
        console.log(padLeft_any("Hello world", 4)); // returns "Hello world"
